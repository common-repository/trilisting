...
add_action( 'widgets_init', 'trilisting_widget_shortcodes' );
if ( ! function_exists( 'trilisting_widget_shortcodes' ) ) {
	function trilisting_widget_shortcodes() {
		return register_widget( 'Trilisting_Shortcodes_Widgets' );
	}
}

if ( ! class_exists( 'Trilisting_Shortcodes_Widgets' ) ) {
	/**
	 * Core class used to implement a Shortcodes widget.
	 *
	 * @since 2.8.0
	 *
	 * @see WP_Widget
	 */
	class Trilisting_Shortcodes_Widgets extends WP_Widget {
		/**
		...
		public function __construct() {
			$widget_ops = [
				'classname'                   => 'trilisting_shortcodes_widgets',
				'description'                 => esc_html__( 'Add shortcodes.', 'trilisting' ),
				'customize_selective_refresh' => true,
			];
			parent::__construct( 'trilisting_shortcodes_widgets', $name = '[triListing] Shortcodes', $widget_ops );
		}
		...
		public function form( $instance ) {
			...
			<?php if ( ! $this->is_legacy_instance( $instance ) ) : ?>
				...
				?>
				<a class="button trilisting-media-button trilisting-insert-shortcode-button" href="javascript:void(0)" style="margin-bottom: 16px"><?php esc_html_e( 'Add Shortcodes', 'trilisting' ) ?></a>
