...
if ( ! class_exists( 'Trilisting_Category_Walker_default' ) ) {
	class Trilisting_Category_Walker_default extends Walker_Category {
		/**
		...
		public function start_el( &$output, $category, $depth = 0, $args = [], $id = 0 ) {
			...
			$link .= '<div class="trilisting-tax-main-wrap">' . $custom_fields . $cat_name . '</div>' . $count_cat . '</a>';
