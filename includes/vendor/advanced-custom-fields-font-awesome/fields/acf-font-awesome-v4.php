...
if ( ! class_exists( 'acf_field_font_awesome' ) ) :
	...
	class acf_field_font_awesome extends acf_field {
		...
		public function create_field( $field )
		{
			...
			<div class="acf-font-awesome-link-wrap">
				<span class="acf-font-awesome-link-text"><?php esc_html_e( 'Select', 'acf-font-awesome' ) ?></span>
				<a href="https://fontawesome.com/icons?d=gallery&m=free" target="_blank" class="acf-font-awesome-link"><?php esc_html_e( 'Font Awesome icon', 'acf-font-awesome' ) ?></a>
			</div>
			<?php
		}
